...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("==================================================================")
        print("              Use this not for fun, only for revenge !!                ")
        print("              This Bomber Was Created By younus !!                ")
        print("==================================================================")
...
try:
    ...
    type = 0
if type == 1:
    nm = int(input("Enter Number of Calls To Send(Maximum 50000): "))
    if nm > 50000:
    ...
    if cc == "91":
        nm = int(input("Enter Number of Messages To Send(00 For Unlimited): "))
        dl = float(
...
if not cc.strip() == "91":
    if type == 1:
        print(
            '\t\tSorry But Call Bombing is  Only For Indian Numbers!!!!')
        print()
        input('Press Enter To Exit....')
        print('\n\n')
        banner()
